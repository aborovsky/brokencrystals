...
export class AppController {
  ...
  getSecrets(): Record<string, string> {
    ...
    const secrets = {
      codeclimate: process.env.CODECLIMATE_REPO_TOKEN || 'REDACTED',
      facebook: process.env.FACEBOOK_TOKEN || 'REDACTED',
      google_b64: process.env.GOOGLE_B64 || 'REDACTED',
      google_oauth: process.env.GOOGLE_OAUTH || 'REDACTED',
      google_oauth_token: process.env.GOOGLE_OAUTH_TOKEN || 'REDACTED',
      heroku: process.env.HEROKU_TOKEN || 'REDACTED',
      hockey_app: process.env.HOCKEY_APP_TOKEN || 'REDACTED',
      outlook: process.env.OUTLOOK_WEBHOOK || 'REDACTED',
      paypal: process.env.PAYPAL_ACCESS_TOKEN || 'REDACTED',
      slack: process.env.SLACK_TOKEN || 'REDACTED'
    };
    return secrets;
  }
